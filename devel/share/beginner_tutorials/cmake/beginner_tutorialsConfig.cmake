...
if("TRUE" STREQUAL "TRUE")
  set(beginner_tutorials_SOURCE_PREFIX /home/umangty/catkin_workspace/src/beginner_tutorials)
  set(beginner_tutorials_DEVEL_PREFIX /home/umangty/catkin_workspace/devel)
  ...
  set(beginner_tutorials_INSTALL_PREFIX /home/umangty/catkin_workspace/install)
...
if(NOT "/home/umangty/catkin_workspace/devel/include " STREQUAL " ")
  set(beginner_tutorials_INCLUDE_DIRS "")
  set(_include_dirs "/home/umangty/catkin_workspace/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Umang Tiwary <umang.tiwary13@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/umangty/catkin_workspace/src/beginner_tutorials/${idir}'.  Ask the maintainer 'Umang Tiwary <umang.tiwary13@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/umangty/catkin_workspace/devel/lib;/home/umangty/catkin_workspace/devel/lib;/opt/ros/kinetic/lib)
