...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/umangty/catkin_workspace/install/${idir}'.  Ask the maintainer 'Umang Tiwary <umang.tiwary13@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/umangty/catkin_workspace/install/lib;/home/umangty/catkin_workspace/devel/lib;/opt/ros/kinetic/lib)
